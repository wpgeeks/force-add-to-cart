...
use WPGeeks\Plugin\ForceAddToCart\Traits\Singleton;
...
class Bootstrap {
	...
	public function load() {
		$class_load_path = FORCE_ADD_TO_CART_DIR . 'config/load.php';
	...
	protected function load_class( $class_name ) {
		if ( class_exists( $class_name ) ) {
			$key = str_replace( 'WPGeeks\Plugin\ForceAddToCart\\', '', $class_name );
